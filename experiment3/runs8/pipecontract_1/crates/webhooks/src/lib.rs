...
///
/// Sized to fit a representative body once escaped: `:` is now part of the
/// escaping contract alongside `\`, `|` and newline, so colon-bearing bodies
/// (timestamps, "status: open"-style headers) cost an extra byte per colon.

...
///
/// Escaping colons (alongside backslash, `|` and newline) can double the
/// on-the-wire size of a colon-heavy body, so this stays sized for the
/// escaped form, not the raw one.
